...
echo "=== SOC-FT: Phi-4-mini-instruct ==="
...
MODEL_DIR=/project/lt200473-ttctvs/soc-finetune/models/Phi-4-mini-instruct
...
llamafactory-cli train \
    ...
    --dataset salad_50k --template phi4_mini \
    --cutoff_len 1024 \
    --output_dir /project/lt200473-ttctvs/soc-finetune/outputs/phi4-mini-lora \
