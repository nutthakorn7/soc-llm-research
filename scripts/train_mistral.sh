...
echo "=== SOC-FT: Mistral-7B Full Training ==="
echo "Job ID: $SLURM_JOB_ID | Nodes: $SLURM_NODELIST | GPUs: 8"
echo "Start: $(date)"
...
MODEL_DIR=/project/lt200473-ttctvs/soc-finetune/models/Mistral-7B-Instruct-v0.3
...
srun torchrun \
    ...
    --dataset salad_50k --template mistral \
    --cutoff_len 1024 \
    --output_dir /project/lt200473-ttctvs/soc-finetune/outputs/mistral-7b-lora \
