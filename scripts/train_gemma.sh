...
echo "=== SOC-FT: Gemma-3-4B Full Training ==="
...
MODEL_DIR=/project/lt200473-ttctvs/soc-finetune/models/gemma-3-4b-it
...
srun torchrun \
    ...
    --dataset salad_50k --template gemma \
    --cutoff_len 1024 \
    --output_dir /project/lt200473-ttctvs/soc-finetune/outputs/gemma3-4b-lora \
