...
echo "=== SOC-FT: Qwen2.5-7B Full Training ==="
...
MODEL_DIR=/project/lt200473-ttctvs/soc-finetune/models/Qwen2.5-7B-Instruct
...
srun torchrun \
    ...
    --dataset salad_50k --template qwen \
    --cutoff_len 1024 \
    --output_dir /project/lt200473-ttctvs/soc-finetune/outputs/qwen25-7b-lora \
