...
echo "=== SOC-FT: DeepSeek-R1-Distill-Qwen-7B ==="
...
MODEL_DIR=/project/lt200473-ttctvs/soc-finetune/models/DeepSeek-R1-Distill-Qwen-7B
...
llamafactory-cli train \
    ...
    --dataset salad_50k --template deepseekr1 \
    --cutoff_len 1024 \
    --output_dir /project/lt200473-ttctvs/soc-finetune/outputs/deepseek-r1-7b-lora \
