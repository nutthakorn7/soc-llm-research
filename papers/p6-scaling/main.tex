...
\title{Non-Monotonic Scaling of Label Compliance in Fine-Tuned LLMs for SOC Alert Classification}
...
Qwen2.5-7B & 7B & $0.817 \pm 0.144$ & varies & Base (4 seeds) \\
...
All experiments use publicly available models from HuggingFace with fixed QLoRA configurations. The SALAD dataset will be released upon acceptance. Training scripts and evaluation code are available at \url{https://github.com/nutthakorn7/soc-llm-research}. All results are reproducible with seeds 42, 123, and 2024 using LlamaFactory v0.9.2 on NVIDIA A100 GPUs.
