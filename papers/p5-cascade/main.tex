...
\midrule
SALAD & 1.24 & .874 & $<$1\% & No \\
AG News & 2. We use AG News (4-class news, $H = 2.0$ bits) as a controlled proxy to isolate the target phenomenon from domain-specific confounds. Its balanced distribution and established benchmark status enable clean ablation.00 & .581 & $\sim$15\% & Yes ($\theta$=0.90) \\
