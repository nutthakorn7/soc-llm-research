...
\item \textbf{Alignment techniques}: Companion study~\cite{p9} applies DPO/ORPO to label compliance, discovering catastrophic failure (F1 drops from 88.8\% to 0.0\%).
