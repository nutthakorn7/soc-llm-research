...
We predict: Qwen2.5-7B at 4-bit will achieve identical F1 to 16-bit ($\sim$92.0\%, from P20 multi-seed in-domain result), making 4-bit the universal deployment recommendation.
