...
\begin{table}[h]
\centering\caption{Hallucination Rate by Method and Seed}
\label{tab:halluc}
\begin{tabular}{lcccc}
\toprule
...
\begin{table}[h]
\centering\caption{Statistical Summary}
\label{tab:stats}
\begin{tabular}{lcc}
\toprule
...
\begin{table}[h]
\centering\caption{Equivalence-Adjusted Score}
\label{tab:eas}
\begin{tabular}{lccc}
\toprule
...
\begin{table}[h]
\centering\caption{PEFT Configuration Guidance Across Studies}
\label{tab:cross}
\begin{tabular}{lll}
\toprule
