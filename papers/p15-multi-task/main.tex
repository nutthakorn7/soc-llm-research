...
\begin{IEEEkeywords}
multi-task learning, SOC classification, seed sensitivity, label compliance, implicit regularization, format learning
\end{IEEEkeywords}
...
\begin{table}[h]
\centering
\caption{Aggregate MT vs.\ ST Comparison}
\label{tab:aggregate}
\begin{tabular}{lcc}
\toprule
...
\begin{table}[h]
\centering
\caption{Anti-Hallucination Mechanisms: Spectrum}
\label{tab:spectrum}
\begin{tabular}{lcc}
\toprule
...
\begin{table}[h]
\centering
\caption{Operational Deployment Comparison}
\label{tab:deploy}
...
All experiments use Qwen3.5-0.8B, LlamaFactory v0.9.2, QLoRA rank 64, NVIDIA A100 80GB. Seeds: 42, 77, 999. Clean zero-overlap data splits. Code at \url{https://github.com/nutthakorn/soc-label-gap}.
