# Model Card: SOC-FT (Fine-Tuned LLMs for SOC Alert Triage)
...
| **Training Cost** | 1.86h GPU, $3.72 cloud equivalent |
| **CO₂ Footprint** | 0.37 kg (single model) |
...
| **Attack Categories** | Analysis, Backdoor, DoS, Exploits, Fuzzers, Generic, Reconnaissance |
...
3. **No adversarial robustness**: Perturbation testing shows typos, case changes, and synonyms affect 72.4% of patterns. Model behavior under these perturbations is untested.
...
|---|---|---|
| GPU Hours | 1.86h | 27.2h |
| Electricity | 0.74 kWh | 10.9 kWh |
| CO₂ | 0.37 kg | 5.4 kg |
| Cloud Cost | $3.72 | $54.46 |
